Scaling [tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml -f ollama.yml

tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/ymls/tml-multi-agenticai-iot-3f10-ml_agenticai-c8df
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml_agenticai-c8df
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-ml_agenticai-c8df
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-ml_agenticai-c8df
             image: makaeron20@gmail.com/tml-multi-agenticai-iot-3f10-ml_agenticai-c8df-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-ml_agenticai-c8df'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10'
             - name: GITUSERNAME
               value: 'makaeron'
             - name: GITREPOURL
               value: 'https://github.com/makaeron/raspberrypitss_02.git'
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tml-multi-agenticai-iot-3f10-ml_agenticai-c8df-visualization-service
       labels:
         app: tml-multi-agenticai-iot-3f10-ml_agenticai-c8df-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-ml_agenticai-c8df 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df.yml
