[tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/makaeron/raspberrypitss_02/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/makaeron/raspberrypitss_02.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45657  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='makaeron'  \-\-env DOCKERUSERNAME='makaeron20@gmail.com'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
[tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=42885, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=39487, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=46341, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=41455, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=43901, HPDEHOST=172.17.0.2, HPDEPORT=35299, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=39117

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2375-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-2078-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-ml-1510-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-predict-3931-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-6395-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
