...
.. important::
   https://github.com/makaeron/raspberrypitss/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/makaeron/raspberrypitss  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46349  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='makaeron'  \-\-env DOCKERUSERNAME='makaeron20@gmail.com'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   https://github.com/makaeron/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=45515, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=45689, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=43499, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=41675, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=41265, HPDEHOST=172.17.0.2, HPDEPORT=33719, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=35265

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2338-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-7944-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-ml-5168-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-predict-4510-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-3488-tml-multi-agenticai-iot-3f10-ml_agenticai-c8df,solution_preprocessing_ml_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
