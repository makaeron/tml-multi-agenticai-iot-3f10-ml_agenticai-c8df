[tml-multi-agenticai-iot-3f10-ml_agenticai-c8df] Details
============================

Generated On: 2026-03-30 16:19:42 UTC

TML Solution DAG Parameters' Details: User Chosen Parametets
----------------------------

STEP 1: Get TML Core Params: `tml_system_step_1_getparams_dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_1_getparams_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - **User Parameter**
     - **Chosen Value**
   * - solutionname
     - tml-multi-agenticai-iot-3f10-ml_agenticai-c8df
   * - solutiontitle
...
STEP 2: Create Kafka Topics: `tml_system_step_2_kafka_createtopic_dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_2_kafka_createtopic_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 3: `Produce to Kafka Topics <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 4: Preprocesing Data: `tml-system-step-4-kafka-preprocess-dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_4_kafka_preprocess_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 4a: Preprocesing Data: `tml-system-step-4a-kafka-preprocess-dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_4a_kafka_preprocess_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 4b: Preprocesing Data: `tml-system-step-4b-kafka-preprocess-dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_4b_kafka_preprocess_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 4c: Preprocesing Data: `tml-system-step-4c-kafka-preprocess-dag  <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_4c_kafka_preprocess_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 5: Entity Based Machine Learning : `tml-system-step-5-kafka-machine-learning-dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_5_kafka_machine_learning_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. list-table::
   ...
   * - ML Output Github Link
     - `Output Data URL <https:\/\/github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/mldata/iotlogistic>`_

STEP 6: Entity Based Predictions: `tml-system-step-6-kafka-predictions-dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_6_kafka_predictions_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
STEP 7: Real-Time Visualization: `tml-system-step-7-kafka-visualization-dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_7_kafka_visualization_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^
...
STEP 8: `tml_system_step_8_deploy_solution_to_docker_dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_8_deploy_solution_to_docker_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^
.. list-table::
   ...
   * - **User Parameter**
     - **Chosen Value**
   * - Docker Container
     - makaeron20@gmail.com/tml-multi-agenticai-iot-3f10-ml_agenticai-c8df-amd64 (https://hub.docker.com/r/makaeron20@gmail.com/tml-multi-agenticai-iot-3f10-ml_agenticai-c8df-amd64)
   * - Docker Run Command
     - docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-multi-agenticai-iot-3f10-ml_agenticai-c8df \
          ...
          makaeron20@gmail.com/tml-multi-agenticai-iot-3f10-ml_agenticai-c8df-amd64

STEP 9: `tml_system_step_9_privategpt_qdrant_dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_9_privategpt_qdrant_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^
.. list-table::
...
STEP 9b: `tml_system_step_9b_agenticai_dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_9b_agenticai_dag-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^
.. list-table::
...
STEP 10: `tml_system_step_10_documentation_dag <https://github.com/makaeron/raspberrypitss_02/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10/tml_system_step_10_documentation_dag_tml-multi-agenticai-iot-3f10-tml-multi-agenticai-iot-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^
.. list-table::
   ...
   * - Solution Documentation URL
     - https://tml-multi-agenticai-iot-3f10-ml-agenticai-c8df.readthedocs.io
